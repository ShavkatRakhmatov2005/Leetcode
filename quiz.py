...
class Button(QRadioButton):
    def __init__(self, txt, parent=None):
        super().__init__(txt, parent)
        self.setFont(QFont("Berlin Sans FB", 25))
        self.setStyleSheet('''
            QRadioButton {
                font-size: 17px;    
            }''')
...
class Window(QWidget):
    def __init__(self):
        ...
        self.questions = [
            ...
            {"question": "2-Eng Katta Qit'a", "options": ["Yevroosiyo", "Amerika", "Afrika", "Avstraliya"], "correct": "Afrika"},
        ...
        self.question_label.setGeometry(20, 50, 200, 30)
        ...
        self.empty.setStyleSheet("QPushButton { background-color: white; color: white; }")
